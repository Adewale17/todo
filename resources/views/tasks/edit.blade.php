...
@section('content')
    ...
    @can('update', $task)
        <form action="{{ route('tasks.update', $task->id) }}" method="POST">
            ...
            <div class="mb-3">
                Title<input type="text" id="title" class="form-control @error('title') is-invalid @enderror" name="title"
                    value="{{ $task->title }}">
            ...
            <div class="mb-3">
                Start Time<input type="time" id="start_time" name="start_time"
                    class="form-control @error('start_time') is-invalid @enderror" value="{{ $task->start_time }}">
                <div class="invalid-feedback">
                    @error('start_time')
                        {{ $message }}
                    @enderror
            ...
            <button type="submit" id="addTask" name="submit" class="btn btn-primary">Update Task</button>
        </form>
    @endcan
    <br>
@endsection
